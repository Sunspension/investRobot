...
class TestLongStrategy:
    ...
    def test_init(self):
        ...
        strategy = LongStrategy(figi="FUTIMOEXF000", position_sizing_service=mock_position_sizing_service)
    ...
    def test_init_with_custom_figi(self):
        ...
        mock_position_sizing_service = Mock()
        strategy = LongStrategy(figi="CUSTOM_FIGI", position_sizing_service=mock_position_sizing_service)
    ...
    async def test_execute_sell_signal(self):
        ...
        # Устанавливаем ожидание продажи
        ...
        position_context = create_position_context(quantity=5, has_position=True, direction='long')
    ...
    async def test_execute_trending_up(self):
        ...
        # Создаем контекст позиции с позицией
        position_context = create_position_context(quantity=2, has_position=True, direction='long')

...
def stream(api_client):
    ...
    return MarketDataStream(api_client, "FUTIMOEXF000", cache_size=100, watchdog_enabled=False, watchdog_stale_seconds=120, watchdog_require_open_market=True)

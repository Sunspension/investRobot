...
from visualization.adapters.sink_impl import DataManagerSink
...
def test_data_manager_sink_add_market_status_and_order():
    ...
    intent = Mock(figi='TEST', direction=Mock(name='BUY'), quantity=3, strategy='str1')
    sink.add_order(execution, intent)
    snap = dm.get_data_snapshot()
